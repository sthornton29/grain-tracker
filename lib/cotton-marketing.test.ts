...
function crop(id: string, name: string): Crop {
  return { id, name, base_moisture_pct: 0, base_lb_per_bushel: 0, harvest_category: 'fall', double_crop: false, combine_adjustment_bu_per_acre: null, rma_type_override: null }
}
