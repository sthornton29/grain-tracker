...
| Testing / CI | **Vitest `^4.1.8`** — 518 unit tests over the pure `lib/` math (17 `lib/*.test.ts` files); ESLint (`.eslintrc.json`, `next/core-web-vitals`); **GitHub Actions CI** (`.github/workflows/ci.yml`: lint + test on every push/PR) |
