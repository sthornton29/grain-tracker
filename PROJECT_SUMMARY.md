...
>
> _Snapshot date: 2026-07-02. Schema at migration `036`._
...
| Testing / CI | **Vitest `^4.1.8`** — 383 unit tests over the pure `lib/` math (13 `lib/*.test.ts` files); ESLint (`.eslintrc.json`, `next/core-web-vitals`); **GitHub Actions CI** (`.github/workflows/ci.yml`: lint + test on every push/PR) |
