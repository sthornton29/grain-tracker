...
- **Unit tests** — 302 Vitest tests across 11 `lib/*.test.ts` files (shrink, yields, csv, contracts, marketing, crop-insurance, government-payments, revenue-projections, hedging, load-splits, program-config) with hand-verified worked examples; run in CI on every push/PR.
