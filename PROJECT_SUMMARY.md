...
>
> _Snapshot date: 2026-07-07. Schema at migration `036`._
...
| `/reports/arc-plc-decision-aid` | **ARC/PLC Decision Aid** — compare projected PLC vs ARC-CO per farm/commodity; set election. Surfaces the shared **MYA Prices panel** (see Government Payment Tracker) so the MYA driving each PLC projection is visible and toggleable right on the page; the What-If MYA % slider applies on top of the resolved price. |
